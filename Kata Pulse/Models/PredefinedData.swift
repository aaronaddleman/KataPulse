...
let predefinedKicks = [
    ...
    Kick(id: UUID(uuidString: "F4C8D92A-7D1C-4C8A-A1A4-5E73B1D60E92")!, name: "4 Count Kick"),
    Kick(id: UUID(uuidString: "B6F7E8D9-3A2C-4E6B-92F1-7A39C4A5D8E3")!, name: "7 Count Kick"),
    Kick(id: UUID(uuidString: "D4E2C1F8-5A3E-4C7B-85F9-3C7A1D6F2B1A")!, name: "10 Count Kick"),
    Kick(id: UUID(uuidString: "F1E2D3C4-B5A6-4C7D-92F8-3A4B5C6D7E8F")!, name: "Crescent Kick"),
    Kick(id: UUID(uuidString: "A4E7B3C2-D9F6-4A5D-85C7-2E8F3A7B4D6C")!, name: "4 Count Kick with Cross Step"),
    Kick(id: UUID(uuidString: "C7B5A6D4-E3F2-4C8B-92F9-7A3B4E6C2D5A")!, name: "7 Count Kick with Cross Step"),
    Kick(id: UUID(uuidString: "E3C4B6A5-D7F2-4A8D-85C9-3C7A4D5F2E6B")!, name: "10 Count Kick with Cross Step"),
    Kick(id: UUID(uuidString: "B2A7E6C3-D5F4-4C9B-92A8-7C3D5E6F4A9B")!, name: "Forward Snap Kick to Crescent Kick"),
    Kick(id: UUID(uuidString: "D9F4E3A7-B5C6-4A8D-85E9-4B7C3F2E6A5D")!, name: "Shuffle Forward to Snap Kick"),
    Kick(id: UUID(uuidString: "C2E8A5D4-B6F3-4A9D-85C7-3E7A9B4D6F2C")!, name: "Wheel Kick"),
    Kick(id: UUID(uuidString: "D7B4E9C3-A5F6-4C8D-92F3-7C2A5E6B4D9F")!, name: "Side Thrust"),
